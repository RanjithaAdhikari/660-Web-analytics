# -*- coding: utf-8 -*-
"""
Created on Wed Nov 01 15:18:29 2017
...
if __name__=='__main__':
        newpath = r'Yelp-Hoboken'                                   #Creating folder for elp to store the restaurant reviews
        if not os.path.exists(newpath):
           os.makedirs(newpath)
        path='C:\Users\Keval\Documents\List_hoboken.txt'    #Reading the file from which the restaurants names are taken to search in Yelp and Scrape the reviews
        fin=open(path)
        for line in fin:                                        #For each name of restaurant in the List
                ...
                url='https://www.yelp.com/biz/'+restraunt_name+'-hoboken'           #Creating URL for restaurant
